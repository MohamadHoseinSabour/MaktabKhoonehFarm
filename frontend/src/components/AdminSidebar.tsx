...
export function AdminSidebar() {
  ...
  return (
    <aside className="admin-sidebar" style={{ top: '100px' }}>
      <h3>پنل مدیریت</h3>
      <nav className="stack" style={{ gap: '0.5rem', marginTop: '1rem' }}>
        <Link href="/admin/courses" className={pathname === '/admin/courses' ? 'active' : ''}>
        ...
        <Link href="/admin/ai-config" className={pathname === '/admin/ai-config' ? 'active' : ''}>
